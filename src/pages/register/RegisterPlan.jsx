...
export const RegisterPlan = ({ handleRegisterForm, registerForm, setRegisterForm }) => {
    return (
        <>
            <div className="mx-auto md:max-w-lg w-full">
                ...
                <div className="mt-6 flex flex-row gap-3 items-center">
                    <Input type="checkbox" className="w-4 h-4 rounded border-gray-300 shadow-sm checked:bg-blue-500 checked:border-blue-500 focus:ring-2 focus:ring-blue-300" />
