            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10">
                    <div className="flex-1 animate-fade-in animation-delay-100">
                        ...
                        <p className="text-4xl md:text-7xl font-bold mx-auto text-center md:text-start">Run your business with total clarity</p>
                ...
                <div className="flex items-center gap-4 justify-center animate-fade-in animation-delay-600">
                    {stats.map((stat) =>
